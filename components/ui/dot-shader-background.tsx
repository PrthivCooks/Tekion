...
// Workaround for TypeScript error: Property 'mesh' does not exist on type 'JSX.IntrinsicElements'
...
function Scene() {
  ...
  // Hardcoded theme for Cyber Black aesthetics
  const themeColors = {
      dotColor: '#00f0ff', // Cyber primary
      bgColor: '#050505', // Cyber black
      dotOpacity: 0.15
  }
