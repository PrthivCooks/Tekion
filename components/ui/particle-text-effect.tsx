...
const DEFAULT_WORDS = ["INTELLIGENT", "SECURE", "AI-POWERED", "FAST", "TECKION"]
...
export function ParticleTextEffect({ words = DEFAULT_WORDS }: ParticleTextEffectProps) {
  ...
  const nextWord = (word: string, canvas: HTMLCanvasElement) => {
    ...
    offscreenCtx.font = "bold 80px monospace" // Slightly smaller font
  ...
  const animate = () => {
    ...
    // Background with motion blur (transparent)
    ...
    if (frameCountRef.current % 180 === 0) { // Every 3 seconds (60fps * 3)
  ...
  useEffect(() => {
    ...
    const updateSize = () => {
       ...
       if (parent) {
           ...
           canvas.height = 300; // Fixed height for effect
       } else {
           canvas.width = 800;
           canvas.height = 300;
       }
